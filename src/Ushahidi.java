...
public class Ushahidi extends MIDlet implements ActionListener{
    ...
    public void startApp() {
        Display.init(this);
        //Loading the app theme located in /res.zip
        try
        {
        ...
        //Creating the UI objects, setting command listeners, adding components and commands to forms
       ...
       //Display the initial form of the ushahidi
        main.show();
    }
    ...
    {
        //Navigation of the app via commands
